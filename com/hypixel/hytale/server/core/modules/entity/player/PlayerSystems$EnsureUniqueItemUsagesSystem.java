...
/* 599 */     return (Query<EntityStore>)Query.and(new Query[] { (Query)PlayerRef.getComponentType(), (Query)Query.not((Query)UniqueItemUsagesComponent.getComponentType()) });
/*     */   }
/*     */ 
/*     */   
/*     */   public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
/* 604 */     holder.ensureComponent(UniqueItemUsagesComponent.getComponentType());
/*     */   }
/*     */   
