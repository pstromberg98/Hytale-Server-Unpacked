...
/* 27 */   private static final Message MESSAGE_COMMANDS_TELEPORT_WARP_FAILED_TO_RELOAD = Message.translation("server.commands.teleport.warp.failedToReload");
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public WarpReloadCommand() {
/* 33 */     super("reload", "server.commands.warp.reload.desc");
/* 34 */     requirePermission(HytalePermissions.fromCommand("warp.reload"));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */     
/*    */     try {
/* 52 */       TeleportPlugin.get().loadWarps();
/* 53 */       context.sendMessage(Message.translation("server.commands.teleport.warp.reloaded")
/* 54 */           .param("count", warps.size()));
